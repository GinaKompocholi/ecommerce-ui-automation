...
Feature: Shopping cart
  ...
  @shopping_cart_initial_state @empty_cart
  Scenario: Verify the initial state of an empty shopping cart
    ...
    And user can't proceed to checkout
  ...
  Scenario: Shopping cart with one product
    ...
    And product Bike Light is displayed in the cart
    And the quantity of product Bike Light is 1
    And the price of product Bike Light is $9.99
    And the full name of product Bike Light displayed is Sauce Labs Bike Light
